...
(function($) {
	...
	$.wfactory_483.filters = $.wfactory_483.filters || {
	...
	$.wfactory_483.hooks = $.wfactory_483.hooks || {

		/**
		 * Applies filters to a given input value.
		 */
		run: function(filterName, args) {
			$.wfactory_483.filters.run(filterName, args);
		},
		 ...
		 */
		add: function(filterName, callback, priority) {
			$.wfactory_483.filters.add(filterName, callback, priority);
		}
	};
